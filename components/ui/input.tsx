...
const fieldClasses =
  "w-full rounded-input border border-border bg-surface px-3.5 h-10 text-sm text-textPrimary placeholder:text-textMuted focus:border-accent transition-colors";
